      ...
      <div className="max-w-5xl mx-auto flex flex-col gap-8">
        ...
        <div className="bg-white/40 backdrop-blur-xl border border-white/60 rounded-[3rem] p-6 px-10 flex justify-between items-center shadow-lg">
          ...
          <div className="flex items-center gap-6">
            ...
            <button onClick={handleLogout} className="bg-red-400 text-white px-5 py-2 rounded-[2rem] font-bold shadow-md transition-all active:scale-95">
              登出
            </button>
          </div>
        </div>
        ...
        <div className="bg-white/40 backdrop-blur-xl border border-white/60 rounded-[3rem] p-10 shadow-lg min-h-[60vh]">
          <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
            ...
            <select 
              ...
              className="bg-white/60 border-none text-gray-700 rounded-[2rem] px-6 py-3 shadow-sm outline-none cursor-pointer"
            >
          ...
          {filteredSolutions.length === 0 && (
            <div className="text-center py-20 text-gray-400">目前尚無此科目的解答</div>
          )}
        </div>
      </div>
