          ...
          <div className="mt-12 pt-8 border-t border-slate-100 dark:border-slate-800 text-center space-y-5">
            <div className="px-2">
              ...
              <p className="text-[10px] text-slate-400 dark:text-slate-500 leading-relaxed font-bold">
                TerryEdu 是專為校內學生設計的個人化學習平台。我們透過 Google OAuth 驗證身分，確保教學資源僅限授權學生存取，並提供解答共享及進度追蹤功能。
              </p>
            </div>
            <div className="flex justify-center items-center gap-5">
              <a href="/privacy" className="text-[11px] font-black text-teal-600 dark:text-teal-400 hover:underline underline-offset-4">
